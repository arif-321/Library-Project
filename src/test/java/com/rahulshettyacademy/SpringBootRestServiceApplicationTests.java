...
public void addBookTest()
{
	...
	ResponseEntity response = con.addBookImplementation(buildLibrary()); //changes in MockMVC
...
public void addBookControllerTest() throws Exception
{
	...
	this.mockMvc.perform(post("/addBook").contentType(MediaType.APPLICATION_JSON).content(jsonString)).andDo(print()).
	andExpect(status().isCreated()).andExpect(jsonPath("$.id").value(lib.getId()));
